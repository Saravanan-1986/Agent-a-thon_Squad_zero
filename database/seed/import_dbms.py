"""
Idempotent Educational Content Importer for DBMS.
...
def import_dbms_dataset(data_dir: Path, fresh: bool = False) -> dict:
    """Validate and idempotently seed DBMS educational content into the database."""
    ...
    for c in concepts_data:
        ...
        # also map name for legacy resolution
...
def main():
    parser = argparse.ArgumentParser(description="Seed Educational DBMS Dataset into Database")
    ...
    print("=== DBMS Educational Content Importer ===")
    summary = import_dbms_dataset(data_dir, fresh=args.fresh)
    print("\nImport Summary:")
